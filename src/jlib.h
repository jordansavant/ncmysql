...
#define COLOR_MAGENTA_BLACK	7
#define COLOR_BLUE_BLACK	8
#define COLOR_GREEN_BLACK	9
...
#define COLOR_CYAN_BLUE		15
#define COLOR_BLACK_WHITE	16
#define COLOR_BLACK_BLUE	17
#define COLOR_BLACK_YELLOW	18
#define COLOR_BLACK_MAGENTA	19
#define COLOR_BLACK_RED		20
#define COLOR_BLACK_GREEN	21
#define COLOR_WHITE_GREEN	22
#define COLOR_YELLOW_BLUE	23
...
// NCURSES FUNCTIONS
int nc_text_editor_pad(WINDOW *pad, char *buffer, int buffer_len, int *exit_keys, int pad_y, int pad_x, int scr_y, int scr_x, int scr_y_end, int src_x_end);
int nc_text_editor_win(WINDOW *win, char *buffer, int buffer_len, int *exit_keys);
int nc_text_editor(WINDOW *window, char *buffer, int buffer_len, int *exit_keys, bool is_pad, int pad_y, int pad_x, int scr_y, int scr_x, int scr_y_end, int src_x_end);
